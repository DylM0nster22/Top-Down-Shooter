const PERKS = {
    ...
    RICH_GET_RICHER: {
      ...
      effect: (player) => {
        player.stats.currencyMultiplier =
          Math.round(player.stats.currencyMultiplier * 1.2 * 10) / 10;
      },
    ...
    RAPID_FIRE: {
      ...
      effect: (player) => {
        player.stats.fireRate =
          Math.round(player.stats.fireRate * 1.25 * 10) / 10;
      },
    ...
    BULLET_VELOCITY: {
      ...
      effect: (player) => {
        player.stats.bulletSpeed =
          Math.round(player.stats.bulletSpeed * 1.3 * 10) / 10;
      },
    ...
    REGENERATION: {
      ...
      effect: (player) => {
        ...
        const nextLevel = Math.min(
          0.5,
          Math.round((currentRegen + 0.1) * 10) / 10
        );
    ...
    LUCKY_LOOTER: {
      ...
      effect: (player) => {
        player.stats.currencyMultiplier =
          Math.round(player.stats.currencyMultiplier * 1.5 * 10) / 10;
      },
    ...
    XP_BOOST: {
      ...
      effect: (player) => {
        player.stats.xpMultiplier =
          Math.round((player.stats.xpMultiplier || 1) * 1.25 * 10) / 10;
      },
    ...
    BERSERKER: {
      ...
      effect: (player) => {
        ...
        player.health =
          Math.round(Math.min(player.health, player.maxHealth) * 10) / 10;
      },
    ...
    TANK: {
      ...
      effect: (player) => {
        ...
        player.stats.moveSpeed =
          Math.round(player.stats.moveSpeed * 0.9 * 10) / 10;
      },
    ...
    BOUNTY_HUNTER: {
      ...
      effect: (player) => {
        player.stats.currencyMultiplier =
          Math.round(player.stats.currencyMultiplier * 1.3 * 10) / 10;
        player.stats.xpMultiplier =
          Math.round(player.stats.xpMultiplier * 1.3 * 10) / 10;
      },
    ...
    JUGGERNAUT: {
      ...
      effect: (player) => {
        ...
        player.stats.moveSpeed =
          Math.round(player.stats.moveSpeed * 0.7 * 10) / 10;
      },
