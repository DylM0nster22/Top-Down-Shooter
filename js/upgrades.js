const ITEMS = {
    ...
    SPEED_BOOTS: {
        ...
        cost: 120,
        effect: (player) => {
            player.stats.moveSpeed = Math.round(player.stats.moveSpeed * 1.15 * 10) / 10;
        },
    ...
    QUANTUM_CORE: {
        ...
        cost: 200,
        effect: (player) => {
            player.stats.bulletSpeed = Math.round(player.stats.bulletSpeed * 1.4 * 10) / 10;
    ...
    PLASMA_INJECTOR: {
        ...
        effect: (player) => {
            ...
            player.stats.bulletSpeed = Math.round(player.stats.bulletSpeed * 1.15 * 10) / 10;
        },
    ...
    NANO_BOOSTERS: {
        ...
        description: "Increases movement speed by 20% and reduces dash cooldown by 10%"
    },
    SHIELD_GENERATOR: {
        name: "Shield Generator",
        cost: 200,
        effect: (player) => {
            player.stats.shield = Math.round((player.stats.shield || 0) + 1 * 10) / 10;
        },
    ...
    CRIT_MODULE: {
        ...
        cost: 250,
        effect: (player) => {
            player.stats.critChance = Math.round((player.stats.critChance || 0) + 0.1 * 10) / 10;
        },
    ...
    XP_AMPLIFIER: {
        ...
        cost: 300,
        effect: (player) => {
            player.stats.xpMultiplier = Math.round(player.stats.xpMultiplier * 1.2 * 10) / 10;
        },
